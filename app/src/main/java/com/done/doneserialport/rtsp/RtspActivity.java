 ...
 * @author Done
 */
public class RtspActivity extends Activity implements View.OnClickListener,
        RtspClient.Callback,
        Session.Callback,
        SurfaceHolder.Callback,
        RadioGroup.OnCheckedChangeListener {

    public final static String TAG = "RtspActivity";
    ...
    private void initConfig() {
        SharedPreferences mPrefs = PreferenceManager.getDefaultSharedPreferences(RtspActivity.this);
        SharedPreferences.Editor editor = mPrefs.edit();
        editor.putString("uri", getString(R.string.default_stream));
        editor.commit();
        ...
        mEditTextUsername.setText(mPrefs.getString("username", "123456"));
    }
    ...
    public void toggleStream() {
        ...
        if (!mClient.isStreaming()) {
            ...
            port = m.group(2);
            path = m.group(3);
            Log.d(TAG, "ip:" + ip + "port:" + port + "path:" + path);
    ...
    public void onRtspUpdate(int message, Exception e) {
        Log.d(TAG, "message:" + message + ",Exception:" + e.getMessage());
        switch (message) {
